    ...
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/40 backdrop-blur-sm px-4 pb-4 sm:pb-0">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-6 space-y-4">
        ...
        <p className="text-xs text-center text-gray-400 leading-relaxed">
          Pay stubs are generated for personal record-keeping and informational purposes only.
          Results are estimates and may differ from your actual paycheck. Not intended for use in misrepresenting income to any party.
        </p>
      </div>
    </div>
  )
